...
class PaginationHandler:
    ...
    def has_next_page(self) -> bool:
        ...
        try:
            ...
            next_button = self.browser.page.query_selector(NEXT_BUTTON)
            if not next_button:
                return False
    ...
    def has_previous_page(self) -> bool:
        ...
        try:
            prev_button = self.browser.page.query_selector(PREV_BUTTON)
            if not prev_button:
                return False
    ...
    def go_to_previous_page(self) -> bool:
        ...
        try:
            ...
            self._scroll_to_pagination()
            self.browser.click(PREV_BUTTON)
            self.browser.humanizer.random_delay(5000, 10000)
    ...
    def go_to_page(self, page_number: int) -> bool:
        ...
        try:
            ...
            page_buttons = self.browser.get_all_elements(PAGE_BUTTONS)
    ...
    def get_current_page(self) -> int:
        ...
        try:
            current = self.browser.page.query_selector(CURRENT_PAGE)
            if current:
