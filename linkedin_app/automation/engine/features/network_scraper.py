...
class NetworkScraper:
    ...
    def execute(self, keywords: str, location: str = "", start_page: int = 1, max_pages: int = 10, limit: int = 100):
        """
        ...
        def save_batch(profiles: List):
            ...
            for profile in profiles:
                try:
                    ...
                    if self.db.upsert_network_profile(data):
                        batch_saved += 1
